...
class CoefficientExperiment(Experiment):
    ...
    def dataset_setup(self):
        ...
        self.train_dataset = ToyDataset(dataset_size=settings.labeled_dataset_size, observation_count=observation_count,
                                        settings=settings, seed=settings.labeled_dataset_seed, shuffle=True)
        self.train_dataset_loader = DataLoader(self.train_dataset, batch_size=settings.batch_size,
                                               pin_memory=self.settings.pin_memory)
        self.unlabeled_dataset = ToyDataset(dataset_size=settings.unlabeled_dataset_size, shuffle=True,

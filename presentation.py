...
def generate_learning_process_images():
    ...
    fake_examples = np.load('fake_examples.npy', mmap_mode='r')[::10]
    unlabeled_predictions = np.load('unlabeled_predictions.npy', mmap_mode='r')[::10]
    test_predictions = np.load('test_predictions.npy', mmap_mode='r')[::10]
    dnn_test_predictions = np.load('dnn_test_predictions.npy', mmap_mode='r')[::10]
